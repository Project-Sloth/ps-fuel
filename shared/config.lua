...
-- More up-to-date vehicles list: https://www.gtabase.com/grand-theft-auto-v/vehicles/#sort=attr.ct3.frontend_value&sortdir=desc&page=1
Config.Blacklist = {
	--"Adder", (Vehicle Code Example)
	--276773164 (Hash Example)
	"airtug",
	"avisa",
	"bmx",
	"caddy",
